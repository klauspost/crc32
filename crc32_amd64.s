...
remain64:
    ...
    CMPQ        CX, $16     // More than 16 bytes left?
    JB          finish

remain16:
    MOVOU       (SI), X10   // Encode 16 bytes
    MOVOA       X1, X5
    PCLMULQDQ   $0, X0, X1
    PCLMULQDQ   $0x11, X0, X5
    PXOR        X5, X1
...
finish:
    ...
    MOVOA       X1, X2
    MOVQ        r5<>+0(SB), X0    
    PSRLQ       $32, X3              // Creates 32 bit mask. Note that we don't care about upper half.
